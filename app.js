    ...
    <div class="glass-card car-card">
      <a href="${targetLink}" style="display: block; position: relative;">
        <div class="car-image-container">
          ...
          <span class="car-rating"><i class="ri-star-fill"></i> ${car.rating || '5.0'}</span>
      ...
      <div class="car-info">
        ...
        <div class="car-specs">
          <div class="spec-item">
            ...
            <span>${car.specs.speed || '250 km/h'}</span>
          </div>
          <div class="spec-item">
            <i class="ri-timer-flash-line"></i>
            <span>${car.specs.accel || '4.5s'}</span>
          </div>
          <div class="spec-item">
            <i class="ri-fire-line"></i>
            <span>${car.specs.hp || '400 CV'}</span>
          </div>
        </div>
