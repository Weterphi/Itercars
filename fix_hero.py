...
new_hero = """  <section class="hero" style="padding-top: 130px; padding-bottom: 70px; background: radial-gradient(circle at 50% 20%, rgba(0, 146, 70, 0.15) 0%, rgba(6, 6, 12, 1) 70%); text-align: center; position: relative;">
